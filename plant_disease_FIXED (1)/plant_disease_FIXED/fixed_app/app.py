...
# -------------------- IMAGE TRANSFORM --------------------
# FIX: Use the same normalization as training (ResNet18 ImageNet stats)
# Without this, prediction accuracy is significantly lower.
...
def prediction(image_path):
    ...
    input_data = transform(image).unsqueeze(0)   # FIX: use transform instead of manual resize+to_tensor
